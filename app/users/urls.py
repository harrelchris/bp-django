...
urlpatterns = [
    ...
    path(route="email/verify/token/<uuid>/", view=views.email_verify, name="email_verify"),
    path(route="email/verify/resend/", view=views.email_verify_resend, name="email_verify_resend"),
